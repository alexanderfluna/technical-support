  ...
  return (
        <div className="faq-list">
            <div className="faq-answer" id="no-power-light">
                <h1 className="faq-title">How to Troubleshoot a Media Converter with Power Issues</h1>
                <NoPowerLight />
            </div>

            <div className="faq-answer" id="no-optical-link">
                <h1 className="faq-title">How to Troubleshoot a Media Converter with Optical Link Issues</h1>
                <NoOpticalLink />
            </div>

            <div className="faq-answer" id="no-communication">
                <h1 className="faq-title">How to Troubleshoot a Media Converter with no Ethernet Port Activity.</h1>
            ...
            <div className="faq-answer" id="no-poe">
                <h1 className="faq-title">How to Troubleshoot a Media Converter with PoE Issues</h1>
                <NoPoE />
            </div>

            <div className="faq-answer" id="cnfe2mc2c">
                <h1 className="faq-title">How to configure the contacts on a CNFE2MC2C.</h1>
