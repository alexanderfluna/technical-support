  ...
  return (
    <div className="faq-list">
        <div id="formA" className="faq-answer">
          <h1 className="faq-title">Form A Relays</h1>
        ...
        <div id="formC" className="faq-answer">
          <h1 className="faq-title">Form C Relays</h1>
        ...
        <div id="latching" className="faq-answer">
          <h1 className="faq-title">Latching vs. Non-Latching Relays</h1>
        ...
        <div id="supervision" className="faq-answer">
          <h1 className="faq-title">Supervision</h1>
        ...
        <div id="summary" className="faq-answer">
          <h1 className="faq-title">Summary Fault Relays</h1>
