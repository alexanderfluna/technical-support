...
const EthernetSwitch = () => {
  ...
  const handleSectionClick = (content) => {
    ...
    setTimeout(() => {
      if (content === "ethernet-troubleshooting" && troubleshootingRef.current) {
        troubleshootingRef.current.scrollIntoView({ behavior: 'smooth' });
      } else if (content === "ethernet-relevant-information" && relevantInfoRef.current) {
        relevantInfoRef.current.scrollIntoView({ behavior: 'smooth' });
      } else if (content === "ethernet-selector-tool" && selectorToolRef.current) {
