    ...
    return (
      <div className="faq-list">
        ...
        <div id="server-power" className="faq-answer">
          <h1 className="faq-title">How to Troubleshoot a Server With Powering Issues</h1>
          ...
          <div id="no-poe" className="faq-answer">
            <h1 className="faq-title">How to Troubleshoot a Server Switch That is Not Providing PoE</h1>
          ...
          <div id="raid" className="faq-answer">
            <h1 className="faq-title">How to Troubleshoot a Server with a Bad Drive or RAID</h1>
          ...
          <div id="ssd" className="faq-answer">
            <h1 className="faq-title">How to Troubleshoot a Server with a Bad mSATA</h1>
          ...
          <div id="nic" className="faq-answer">
            <h1 className="faq-title">How to Troubleshoot a Server with NIC Issues</h1>
          ...
          <div id="os" className="faq-answer">
            <h1 className="faq-title">How to Troubleshoot a Server Experiencing Issues with the OS</h1>
          ...
          <div id="rdp" className="faq-answer">
            <h1 className="faq-title">How to Set Up a Remote Desktop Connection</h1>
        ...
        <div id="registration" className="faq-answer">
            <h1 className="faq-title">How to Skip the Razberi Monitor Registration</h1>
            <p>While on the registration page, hold down: Ctrl + Shift + Alt + F11.</p>
        </div>
  
        <div id="camera-defense" className="faq-answer">
          <h1 className="faq-title">How to Set Up Camera Defense</h1>
        ...
        <div id="password" className="faq-answer">
          <h1 className="faq-title">What to do if the Windows Password is Forgotten</h1>
    ...
    return (
      <div className="faq-list">  
        <div id="computing" className="faq-answer">
          <h1 className="faq-title">Computing Terminology</h1>
