    ...
    return (
      <div className="faq-list">
        ...
        <div id="server-power" className="faq-answer">
          <h1 className="faq-title" onClick={() => toggleFAQ("server-power")}>How to Troubleshoot a Server With Powering Issues<span className="dropdown-chevron"></span></h1>
          {expandedFAQ === "server-power" && (
            <>
              ...
              <p><strong>[4]</strong> Replace the power cord with a known-working one.</p>
          ...
          <div id="no-poe" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("no-poe")}>How to Troubleshoot a Server Switch That is Not Providing PoE<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "no-poe" && (
              <>
          ...
          <div id="raid" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("raid")}>How to Troubleshoot a Server with a Bad Drive or RAID<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "raid" && (
              <>
                ...
                <p><strong>[2]</strong> Using one of the following, confirm the server's current RAID configuration and that the HDD or RAID has failed. </p>
          ...
          <div id="ssd" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("ssd")}>How to Troubleshoot a Server with a Bad mSATA<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "ssd" && (
              <>
                <p><strong>[1]</strong> Ship the server to us, and we can re-image the unit.</p>
                <p><strong>[2]</strong> We can ship out a new SSD with our image on it.</p>
                <p><strong>[3]</strong> Purchase a new mSATA, install the OS, and we can provide the necessary drivers and software.</p>
              </>
            )}
          </div>
  
          <div id="nic" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("nic")}>How to Troubleshoot a Server with NIC Issues<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "nic" && (
              <>
                <p><strong>[1]</strong> Document if the LEDs illuminate on the NIC when an Ethernet connection is made and if the NIC can be successfully pinged.</p>
                <p><strong>[2]</strong> Enter "View network connections" in the Windows search box.</p>
                <p><strong>[3]</strong> Disable and reenable the NIC.</p>
                <p><strong>[4]</strong> Select the 'Diagnose this connection' option for the NIC.</p>
                <p><strong>[5]</strong> In Device Manager, verify what drivers the NIC has. Contact technical support to determine if all of the necessary drivers are installed.</p>
              </>
            )}
          </div>
  
          <div id="os" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("os")}>How to Troubleshoot a Server Experiencing Issues with the OS<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "os" && (
              <>
                ...
                <p><strong>[2]</strong> Open Disk Mangement to confirm there is only one OS partition and that the RAID is healthy.</p>
                ...
                <p><strong>[5]</strong> If the OS is not accessible, or if there are no signs as to why the OS is having issues, perform a recovery of the OS.</p>
          ...
          <div id="rdp" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("rdp")}>How to Set Up a Remote Desktop Connection<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "rdp" && (
              <>
        ...
        <div id="registration" className="faq-answer">
            <h1 className="faq-title" onClick={() => toggleFAQ("registration")}>How to Skip the Razberi Monitor Registration<span className="dropdown-chevron"></span></h1>
            {expandedFAQ === "registration" && (
              <>
        ...
        <div id="camera-defense" className="faq-answer">
          <h1 className="faq-title" onClick={() => toggleFAQ("camera-defense")}>How to Set Up Camera Defense<span className="dropdown-chevron"></span></h1>
          {expandedFAQ === "camera-defense" && (
              <>
        ...
        <div id="password" className="faq-answer">
          <h1 className="faq-title" onClick={() => toggleFAQ("password")}>What to do if the Windows Password is Forgotten<span className="dropdown-chevron"></span></h1>
          {expandedFAQ === "password" && (
              <>
    ...
    return (
      <div className="faq-list">  
        <div id="computing" className="faq-answer">
          <h1 className="faq-title" onClick={() => toggleFAQ("computing")}>Computing Terminology<span className="dropdown-chevron"></span></h1>
          {expandedFAQ === "computing" && (
              <>
        ...
        <div id="power-over-ethernet" className="faq-answer">
          <h1 className="faq-title" onClick={() => toggleFAQ("power-over-ethernet")}>Power Over Ethernet</h1>
          {expandedFAQ === "power-over-ethernet" && (
              <>
                <PowerOverEthernet />
              </>
            )}
