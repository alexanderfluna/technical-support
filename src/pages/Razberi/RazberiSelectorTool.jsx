                ...
                <div>
                  {selected === "Server Switch" && (
                    <div>
                      ...
                      <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px", paddingTop: "10px"}}>
                        <div>
                        ...
                        <div>
                          <p><strong>RAID Configuration</strong></p>
                  ...
                  {selected === "Server" && (
                    <div>
                      ...
                      <div style={{display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px", paddingTop: "10px"}}>
                        ...
                        <div>
                          <p><strong>SSD (Live Drive)</strong></p>
                        ...
                        <div>
                          <p><strong>Additional Network Options</strong></p>
