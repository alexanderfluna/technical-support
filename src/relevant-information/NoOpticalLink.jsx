const NoOpticalLink = () => {
  return (
    <div>
      ...
      <p style={{paddingLeft: "40px"}}>― Since the data is transmitted and received over a single strand of fiber, using wavelength division multiplexing (WDM), the 'A' and 'B' units transmit and receive data at different wavelengths.</p>
      ...
      <p><strong>3.</strong> To rule out contamination, use a fiber optic cleaning kit to clean the optics on the unit and the connector on the fiber.</p>
      ...
      <p><strong>5.</strong> If the link light remains solid green after removing the fiber, there may be a power issue.</p>
    </div>
